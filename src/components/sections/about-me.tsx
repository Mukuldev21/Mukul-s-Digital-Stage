...
const InfoCard: React.FC<InfoCardProps> = ({ icon: Icon, value, label }) => (
  <Card className="text-center rounded-xl shadow-2xl bg-card/60 dark:bg-card/50 backdrop-blur-lg transition-shadow hover:shadow-lg p-4">
  ...
  return (
    <section id="about-me" className="w-full py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto p-6 sm:p-8 rounded-xl shadow-2xl bg-card/60 dark:bg-card/50 backdrop-blur-lg">
